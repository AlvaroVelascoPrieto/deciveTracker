...
public class ViewDevices extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<DeciveModal> courseModalArrayList = new ArrayList<>();
        DBHandler dbHandler = new DBHandler(ViewDevices.this);
        ...
        DeviceRVAdapter deviceRVAdapter = new DeviceRVAdapter(courseModalArrayList, ViewDevices.this);
